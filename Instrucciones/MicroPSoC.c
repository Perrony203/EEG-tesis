...
uint8_t Conf_values[] = {0x96,0xD0,0xEC, //CONFIG 1,2,3 (El config3 no está probado)
		0x00, //LOFF
		0x60,0x60,0xE1,0xE1,0xE1,0xE1,0xE1,0xE1, //CHSET (0xE1 -> Apagado ; 0x65 -> Señal de prueba ; 0x60 -> Electrodo normal)
		0x03,0x01, //BIASSENS (Para los 5 canales, poner 1F - 01, para pruebas con un solo canal, 01 - 01)0x07,0x07, //BIASSENS
		0x00,0x00, //LOFFSENS
		0x00, //LOFFFLIP
		0x00, //GPIO
		0x00,0x00, //MISC
